...
"""
import time
archivo=open('E:/2021/UNSA/Semestre I/Algoritmos/Practica/Trabajo en equipo/python/archivo100000.txt','r')
#archivo.read()
lista=[]
...
inicio = float(time.time()*1000)
heapsort(lista, len(lista))
fin = float(time.time()*1000)
print(fin-inicio)
#imprimir(lista)
