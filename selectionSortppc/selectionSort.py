...
for canti_data in arr2:
	print(canti_data)
	arr = np.loadtxt(f"D:/trabajos/Maestria/EDM/trabajo1/SelecionSort/data/archivo{canti_data}.txt", dtype=int)
	inicio = time.time()
	selection_sort(arr)
	fin = time.time()
...
print("Inicio de creación del archivo")
file = open("./SelectionSortP.csv", "w")
file. write(str1)    
file. close()
